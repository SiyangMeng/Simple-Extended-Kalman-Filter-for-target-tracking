...
x0 = np.array([1000.0,1500.0,5.0,-3.0])                 # 我这里随意设置了一个初值，与真实值相差较大
# x0 = np.array([4.0,3.0,0.8000,0.35])         # 这是设定中的真实状态初始值
x0 = x0[:,np.newaxis]
# x0 = np.array([[x1],[x2]]) 
...
x0_real = np.array([x0[0,0],x0[1,0],x0[2,0],x0[3,0]])     # 这是设定中的真实状态初始值
...
z0 = np.array([13.0,1.2])               # 对应于准确初始状态的准确测量结果
